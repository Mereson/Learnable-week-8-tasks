    ...
    <article class="task-holder">
      <article class="task">
        <figure class="check-icon">
            <img class="check-img" src="./Resources/check.png" alt="check icon">
        </figure>
        <div>
            <p class="message">${task}</p>
            <figure>
                <img class="edit-btn" src="./Resources/edit.png" alt="edit icon">
                <img class="delete-btn" src="./Resources/delete.png" alt="delete icon">
            </figure>
        </div>
      </article>
      <hr>
